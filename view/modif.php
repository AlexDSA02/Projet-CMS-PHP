        ...
        ///  $i=$j;
          ...
          $localisation=$_GET['localisation'];
            ...
            if ($titre!='' && $com!='')
            {
              echo '<tr><td>'.$titre.'</br>';
              echo '</br>'.$com.'</td>';
              echo '<td><a href="modif2.php?num_para='.($j+2).'"><img src="../img/modif.png" width="50px"></a></td>';
              echo '<td><a href="delete.php?num_para='.($j+2).'"><img src="../img/delete.png" width="50px"></a></td></tr>';           
            }*/
