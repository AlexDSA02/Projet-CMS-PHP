...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('../img/time.jpg')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="page-heading">
              <h1>Agenda</h1>
              <span class="subheading">Toutes nos prochaine activitées</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <a href="#">
              <img class="img-fluid" src="../img/resto.jpg" alt="">
            </a>
